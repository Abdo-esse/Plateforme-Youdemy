  ...
  <div class="p-4">
    <div class="flex justify-between items-start mb-2">
      ...
      <div class="flex gap-2">
        ...
        <a href="update_course.php?id=<?php echo $cours->id?>" class="text-yellow-500 hover:text-yellow-600 transition-colors">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
          </svg>
        </a>
        <a href="delete_course.php?id=<?php echo $cours->id?>" class="text-red-500 hover:text-red-600 transition-colors" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce cours ?');">
          <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
