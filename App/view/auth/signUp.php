...
<div class="h-screen flex items-center justify-center">
    ...
    ?>
        <!-- <p class="text-2xl font-bold text-center mb-4"><?php if (isset($_SESSION['errorGenerale'])) {echo $_SESSION['errorGenerale'];}?></p> -->
  ...
  <select id="countries" required name="idRole" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    <option selected>Chose</option>
    <option value="2">Enseignant</option>
    <option value="3">Étudiant</option>
  </select>
  <button type="submit" name="submit" class=" mt-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
